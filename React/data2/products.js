...
//  Will get all properies and methods from Product class
...
console.log(date.toLocaleDateString()); // convert to local string format


console.log(this);  // undefined in module scope
const object2 ={
  a: 2,
  b: this.a
}
...
logThis();
logThis.call('Wassup Niggas'); // set this to Hello World string
...
export function loadProductsFetch(){
  ...
  .then((response) => {
    ...
    products = productsData.map((productDetails) => {
      ...
      console.log('Unexpct error. Pease try again later.');
    });
...
export function loadProducts(fun){ // Callback. A function to run in the future.
  ...
  xhr.addEventListener('error', (error) => {      // seperate set up for error
    console.log('Unexpct error. Pease try again later.');
  })
...
/* 
.map loops through each object in the array and creates new array
